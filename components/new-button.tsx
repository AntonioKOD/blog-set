    ...
    <StyledWrapper>
      <button className="button">
        <p className="button__text">
          ...
          <span style={{ '--index': 9 } as React.CSSProperties}>D</span>
          <span style={{ '--index': 10 } as React.CSSProperties}>M</span>
          <span style={{ '--index': 11 } as React.CSSProperties}>I</span>
          <span style={{ '--index': 12 } as React.CSSProperties}>N</span>
        </p>
